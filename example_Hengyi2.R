...
# To see the different matrices
xx$pi.mat.list # list element
length(xx$pi.mat.list)

xx$pi.mat.list[[6]] # last matrix

xx$pi.mat.list[[5]][1,] # how many times each unexposed case has been 
# associated with the first exposed case
